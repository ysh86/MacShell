...
/* event.c */
extern		doEventLoop(void);
extern		int inProcEventLoop(int blink);
extern		HandleMouseDown(EventRecord *theEvent);
extern		HandleKeyDown(EventRecord *theEvent);
extern		DoUpdateEvent(EventRecord *theEvent);
extern		DoActivateEvent(EventRecord *theEvent);
extern		short allowDelete(TEHandle teh);
extern		short allowPaste(TEHandle teh);
#ifndef TC7
extern		short doLineEditCommand(char c,short iscmd,TEHandle tempText);
#endif

extern		short lineEditCmd(EventRecord *event);
extern		short doEraseLine(TEHandle teh);
