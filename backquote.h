...
extern short backquoteSubstitute(char **cmdh);
extern short findBQ(char *str);
extern short extractBQSeg(char *inp,char **outh,short *startp,short *lenp);
extern short setupBQStdio(StdioPtr *stdioh);
extern void cleanBQResults(char *buf,short *len);
